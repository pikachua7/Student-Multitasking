        ...
        <div id="calculator">
          ...
          <div id="buttons">
            <div id="layer1">
              ...
              />
              <CalButton value={"\u00B1"} onClick={() => this.changeSign()} />
              <CalButton value={"%"} onClick={() => this.applyPercentage()}/>
              <CalButton
                value={"\u00F7"}
                class={"operator-btn"}
            ...
            <div id="layer2">
              <CalButton value={"7"} onClick={() => this.enterDigit("7")} />
              <CalButton value={"8"} onClick={() => this.enterDigit("8")} />
              <CalButton value={"9"} onClick={() => this.enterDigit("9")} />
              <CalButton
                value={"x"}
                class={"operator-btn"}
            ...
            <div id="layer3">
              <CalButton value={"4"} onClick={() => this.enterDigit("4")} />
              <CalButton value={"5"} onClick={() => this.enterDigit("5")} />
              <CalButton value={"6"} onClick={() => this.enterDigit("6")} />
              <CalButton
                value={"-"}
                class={"operator-btn"}
            ...
            <div id="layer4">
              <CalButton value={"1"} onClick={() => this.enterDigit("1")} />
              <CalButton value={"2"} onClick={() => this.enterDigit("2")} />
              <CalButton value={"3"} onClick={() => this.enterDigit("3")} />
              <CalButton
                value={"+"}
                class={"operator-btn"}
